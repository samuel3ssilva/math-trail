...
al_suggest:'Smart suggestion',al_lang:'Language',chip_now:'now',sum_sessions:'Sessions · 7d',sum_explored:'Explored',sum_moment:'Suggested',sum_focus:'Building now',sum_none:'—',sum_focus_none:'Free play',
...
al_suggest:'Sugestão inteligente',al_lang:'Idioma',chip_now:'agora',sum_sessions:'Sessões · 7d',sum_explored:'Experiências',sum_moment:'Momento',sum_focus:'Construindo agora',sum_none:'—',sum_focus_none:'Brincadeira livre',
